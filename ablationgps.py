...
class UADTrainer:
    ...
    def fit(self):
        ...
        ckpt=os.path.join(self.cfg.uad_ckpt_dir,f"stgraphtcn_best_{self.cfg.uad_ablation_mode}.pt")
        ...
        uad_plot_train_curves(hist, os.path.join(self.cfg.uad_fig_dir,f"train_curve_{self.cfg.uad_ablation_mode}.png"))
    ...
    def _collect_train_residuals(self) -> Tuple[np.ndarray, np.ndarray]:
        ...
        for p in sorted(train_sources):
            preds,truth,t_idx,naive = uad_rolling_forecast(
                self.model,p,self.node_names,self.scaler,
    ...
    def compute_thresholds(self):
        ...
        plt.savefig(os.path.join(self.cfg.uad_fig_dir,f"train_scalar_residual_hist_{self.cfg.uad_ablation_mode}.png")); plt.close()
